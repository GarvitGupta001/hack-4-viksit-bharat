...
const apiClient = {
  ...
  async getAllSellers(params = {}) {
    ...
    const endpoint = queryParams ? `/sellers/all?${queryParams}` : '/sellers/all';
  ...
  async getCarbonCoinHistory(params = {}) {
    const queryParams = new URLSearchParams(params).toString();
    const endpoint = queryParams ? `/carboncoins/history?${queryParams}` : '/carboncoins/history';
  ...
  async getCarbonCoinLeaderboard(params = {}) {
    const queryParams = new URLSearchParams(params).toString();
    const endpoint = queryParams ? `/carboncoins/leaderboard?${queryParams}` : '/carboncoins/leaderboard';
